...
class Locators:
    ...
    page_login_registration_link = ".//a[(@class = 'Auth_link__1fOlj')]"
    #main page:
    ...
    page_main_constructor_tab_xpath = ".//p[@class='AppHeader_header__linkText__3q_va ml-2' and text()='Конструктор']"
    page_main_constructor_logo_xpath = ".//div[@class='AppHeader_header__logo__2D0X2']"
    ...
    page_main_sections_xpath = ".//span[(@class='text text_type_main-default')][2]"
    #registration page:
    page_registration_url="https://stellarburgers.nomoreparties.site/register"
    page_registration_register_button = (".//button[(@class='button_button__33qZ0 button_button_type_primary__1O7Bx button_button_size_medium__3zxIa')]")
    page_registration_enter_button = ".//a[(@class = 'Auth_link__1fOlj' and text()='Войти')]" #кнопка - войти
    page_registration_name_field = (By.CSS_SELECTOR, "input[name='name']")
    page_registration_email_field = (By.CSS_SELECTOR, "input[name='email']")
    page_registration_password_field = (By.CSS_SELECTOR, "input[type='password']")
    ...
    page_personal_account = "https://stellarburgers.nomoreparties.site/account/profile"
    ...
    page_personal_account_label_here_you_can = (By.XPATH,".//p[@class='Account_text__fZAIn text text_type_main-default' and text()='В этом разделе вы можете изменить свои персональные данные']")
